...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Inserisci 1 se vuoi inserire un evento altrimenti inserisci 2 se vuoi inserire un concerto");
        int choiceType = 0;
        ...
        switch (choiceType){
            case 1:
                ...
                while (choice != 0) {
                    try {
                        System.out.println("Inserisci 1 se vuoi aggiungere dei posti, tasto 2 se vuoi rimuovere dei posti, tasto 3 se vuoi avere i dettagli, tasto 0 se vuoi rimuovere dei posti");
                    ...
                    try {
                        ...
                        switch (choice){
                            case 0:
                                break;
                            case 1:
                                System.out.println("Qunati puosti vuoi prenotare? Posti al momento disponibili: " + concert.getPlaceTotal());
                                int place = Integer.parseInt(scanner.nextLine());
